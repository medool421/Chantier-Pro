    ...
    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.formGroup}>
          ...
          <TextInput style={styles.input} placeholder="Ex: Rénovation Villa H" value={form.name} onChangeText={(t) => handleChange('name', t)} />
        </View>

        <View style={styles.formGroup}>
          <Text style={styles.label}>Lieu *</Text>
          <TextInput style={styles.input} placeholder="Ex: 12 Rue de la Paix, Paris" value={form.address} onChangeText={(t) => handleChange('address', t)} />
        </View>

        <View style={styles.formGroup}>
          <Text style={styles.label}>Description</Text>
          <TextInput style={[styles.input, styles.textArea]} placeholder="Détails des travaux..." value={form.description} onChangeText={(t) => handleChange('description', t)} multiline numberOfLines={4} />
        </View>

        <View style={styles.formGroup}>
          <Text style={styles.label}>Date de début (YYYY-MM-DD)</Text>
          <TextInput style={styles.input} placeholder="Ex: 2024-10-01" value={form.startDate} onChangeText={(t) => handleChange('startDate', t)} />
        </View>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, fontWeight: 'bold', color: colors.textDark, marginBottom: 8 },
  headerSubtitle: { fontSize: 16, color: colors.textMuted, marginBottom: 32 },
  ...
  submitButton: { backgroundColor: colors.primary, borderRadius: 12, padding: 18, alignItems: 'center', marginTop: 20 },
